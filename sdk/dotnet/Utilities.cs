...
namespace Pulumi.TerraformAwsIam
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.TerraformAwsIam.version.txt");
    ...
    internal sealed class TerraformAwsIamResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public TerraformAwsIamResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
