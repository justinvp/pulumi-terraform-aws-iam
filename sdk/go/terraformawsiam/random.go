...
func NewRandom(ctx *pulumi.Context,
	...
	var resource Random
	err := ctx.RegisterResource("terraform-aws-iam:index:Random", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRandom(ctx *pulumi.Context,
	...
	var resource Random
	err := ctx.ReadResource("terraform-aws-iam:index:Random", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
