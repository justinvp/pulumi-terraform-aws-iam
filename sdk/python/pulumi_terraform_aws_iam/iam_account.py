...
__all__ = ['IamAccountArgs', 'IamAccount']

@pulumi.input_type
class IamAccountArgs:
    def __init__(__self__, *,
                 account_alias: pulumi.Input[str],
                 allow_users_to_change_password: Optional[pulumi.Input[bool]] = None,
                 create_account_password_policy: Optional[bool] = None,
                 get_caller_identity: Optional[bool] = None,
        ...
        :param bool create_account_password_policy: Whether to create AWS IAM account password policy.
        :param bool get_caller_identity: Whether to get AWS account ID, User ID, and ARN in which Terraform is authorized.
    ...
    def create_account_password_policy(self) -> Optional[bool]:
        """
    ...
    def create_account_password_policy(self, value: Optional[bool]):
        pulumi.set(self, "create_account_password_policy", value)

    @property
    @pulumi.getter(name="getCallerIdentity")
    def get_caller_identity(self) -> Optional[bool]:
        """
    ...
    def get_caller_identity(self, value: Optional[bool]):
...
class IamAccount(pulumi.ComponentResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a IamAccount resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a IamAccount resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param IamAccountArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IamAccountArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is not None:
            ...
            __props__ = IamAccountArgs.__new__(IamAccountArgs)
        ...
        super(IamAccount, __self__).__init__(
            'terraform-aws-iam:index:IamAccount',
            resource_name,
            __props__,
            opts,
            remote=True)
